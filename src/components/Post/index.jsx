    ...
    return(
        <div className="postMain">
            ...
            <div className="post-icons">
                <svg className="like-btn" onClick={toggleLike} fill={isLiked ? '#000' : '#ed4956'} viewBox="0 0 48 48">
                ...
                <svg aria-label="Comment" className="comment-icon" role="img" viewBox="0 0 48 48" width="24">
